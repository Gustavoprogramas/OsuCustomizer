...
public struct CursorSettings
{
    ...
    [MarshalAs(UnmanagedType.I1)]
    public bool enable_glow;
    [MarshalAs(UnmanagedType.I1)]
    public bool enable_white_center;

    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 260)]
    public string cursor_image_path;
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 260)]
    public string trail_image_path;

    [MarshalAs(UnmanagedType.I1)]
    public bool enable_motion_blur;
    public float blur_intensity;

   
    public float cursor_scale;      

    [MarshalAs(UnmanagedType.I1)]
    public bool enable_raw_input;   

    public float raw_sensitivity;   // Depois desenvolver solução para isso
